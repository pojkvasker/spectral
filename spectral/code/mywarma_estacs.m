function [a,gamma]=mywarma_estacs(r,n,m,M)
% The modified Yule-Walker ARMA method 
% given by equation (3.7.8) together with the AR coefficients estimated
...
%      n     -> AR model order
%      m     -> MA model order
%      M     -> the constant which determine the amount of overdetermination
